...
const Login = () => {
    ...
    const verifyOtp = async () => {
        ...
        try {
            ...
            navigate("/"); // Redirect to Reset Password with email
        } catch (error) {
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 border outline-none border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                        ...
                        <div className="flex gap-2 justify-center mb-8">
                            {[...Array(6)].map((_, index) => (
                                <input
                                    ...
                                    className="w-12 h-16 border-2 border-gray-200 rounded-xl text-center text-2xl font-semibold focus:border-blue-600 focus:outline-none"
                                />
                            ))}
                        </div>
                        <button
