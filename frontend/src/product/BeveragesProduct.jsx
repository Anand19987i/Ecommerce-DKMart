...
const BeveragesProduct = () => {
    ...
    useEffect(() => {
        const fetchBeverageProducts = async () => {
            try {
                setLoading(true);
                const response = await axios.get(`${PRODUCT_API_END_POINT}/Beverages/products/Beverages`, {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 relative" id="shop">
            <h2 className="text-xl md:text-2xl font-bold mb-4 md:text-left">Cold Drinks and Snacks</h2>
            ...
            {loading ? (
                ...
                <p className="text-gray-500 text-center">No beverages available.</p>
            )}
        </div>
    );
};

export default BeveragesProduct;
