...
const ManageProduct = () => {
  ...
  return (
    <>
    <AdminNav/>
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 px-5 sm:px-10 lg:px-20 my-5">
      {products.map((item, index) => (
        <Link key={index} to={`/products-admin/${item.link}`} className="no-underline">
